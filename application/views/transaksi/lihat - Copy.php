                            ...
                            <p class="mb-0">
                                ...
                                <div class="row mt-3">
                                    ...
                                    ?>
                                        ...
                                        <div class="col-md-3 col-xl-3 mt-2 mb-3 menu-card <?= $nm ?>" style="<?= $po ?>" id="pro_<?= $p['id'] ?>" data-id="<?= $p['id'] ?>" harga="<?= $tx_harga ?>" nm_produk="<?= $p['nama_product'] ?>" kategori="<?= $k['id'] ?>" stok="<?= $p['stok'] ?>">
      ...
      <div class="modal-header">
        ...
        <form id="form_tr" autocomplete="off">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-7" style="height: 30rem; overflow-y: auto;">
    ...
    $(document).ready(function () {
        ...
        $('#btn_transaksi').on('click', function () {
            ...
            $.ajax({
                ...
                data        : {aksi_btn:aksi_btn, tunai:tunai, kembalian:kembalian, total_harga:total_harga, total_diskon:total_diskon, qty_list:qty_list, diskon_list:diskon_list, subtotal_list:subtotal_list, id_produk:id_produk, id_pelanggan:id_plg},
                dataType    : "JSON",
